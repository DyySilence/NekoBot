...
const PROMPT = "Transform this anime character into a real human while strictly preserving identity. Keep the exact same age appearance, same facial structure, same proportions, same hairstyle, same expression, same outfit design. Do not redesign or reinterpret the character. This is a realistic live-action adaptation of the exact same person. Photorealistic skin texture, natural pores, realistic eyes with accurate iris color, detailed hair strands, natural lighting, cinematic photography, 85mm lens, shallow depth of field, ultra high resolution, RAW photo, highly detailed, lifelike human version. Maintain original face shape, eye size proportion adjusted naturally but still recognizable, keep original vibe and personality. No stylization, no beautifying filter, no plastic skin. identity preservation is the highest priority, do not change age, do not change face shape, do not westernize, do not beautify, no redesign, 100% faithful realistic translation.";
...
const handler = async (m, { conn }) => {
  ...
  const fileName = imageNode.fileName || `toreall-${Date.now()}.jpg`;
