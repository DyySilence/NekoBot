...
const PROMPT = "Transform this subject into a realistic zombie version while strictly preserving identity. Keep the exact same age appearance, same facial structure, same proportions, same hairstyle, same outfit design. Do not redesign or change the character's core features. This is the same person, infected and turned into a zombie. Maintain recognizable face shape and bone structure. Photorealistic skin texture with pale, decayed skin, subtle wounds, cracked lips, dark eye circles, slightly cloudy eyes. Realistic blood stains and torn clothing but keep original outfit recognizable. Cinematic horror lighting, ultra detailed skin texture, natural pores, 85mm lens, shallow depth of field, high resolution, RAW photo, hyper realistic, live action adaptation. Identity preservation is the highest priority. Do not change age. Do not beautify. 100% faithful realistic infected version.";
...
const handler = async (m, { conn }) => {
  ...
  const fileName = imageNode.fileName || `tozombie-${Date.now()}.jpg`;
